	...
	function btn(str) {
		if (str == "join") {
				...
				if (id == "") {
					...
					window.open('/Ginger/Ginger/idCheck.do?id=' + id + '', '',
						'width=400 , height=400');
				}
			} else {
				userInfo.action = "/Ginger/Ginger/LoginForm.jsp";
			}
	}
	 			function inputIdChk(){
		 ...
		 <div class="idForm">
               ...
               <input type="hidden" name="idDuplication" value="idUncheck" >
				...
				<div class="bottomText">
                           아이디가 생각났어여? <a href="/Ginger/Ginger/LoginForm.jsp">뒤로</a>
              </div>
	</form>
</body>
</html>